...
const Admin = () => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch('https://telegram-bot-u2ni.onrender.com/api/admin/users');
  ...
  const fetchGameHistory = async () => {
    try {
      const response = await fetch('https://telegram-bot-u2ni.onrender.com/api/admin/game-history');
      const data = await response.json();
      setGameHistory(data);
    } catch (error) {
  ...
  const updateUser = async (userId) => {
    try {
      await fetch(`https://telegram-bot-u2ni.onrender.com/api/admin/user/${userId}`, {
        method: 'PUT',
  ...
  const banUser = async (userId) => {
    try {
      await fetch(`https://telegram-bot-u2ni.onrender.com/api/admin/ban/${userId}`, {
        method: 'POST'
      });
      fetchUsers();
      alert('User banned');
  ...
  const sendAnnouncement = async () => {
    try {
      await fetch('https://telegram-bot-u2ni.onrender.com/api/admin/announcement', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
